  ...
  <div class="index-vue">
    ...
    <aside :class="asideClassName">
      ...
      <Menu class="menu"
        ...
        <div v-for="(item, index) in menuItems"
             :key="index">
          <Submenu :class="isShowAsideTitle? '' : 'shrink'"
                   v-if="item.children"
                   :name="index">
            <template slot="title">
              <Icon :size="item.size"
                ...
                <template v-for="(threeItem, k) in subItem.children">
                  <a href="https://www.baidu.com"
                    ...
                    <template v-if="!threeItem.hidden">
                      <a :href="threeItem.url"
                         target="_blank"
                         class="external">
                        <Icon :size="threeItem.size"
                              :type="threeItem.type" />
    ...
    <section class="sec-right">
      ...
      <div class="top-c">
        ...
        <div class="div-tags">
          <ul class="ul-c">
            <li v-for="(item, index) in tagsArry"
                :key="index"
