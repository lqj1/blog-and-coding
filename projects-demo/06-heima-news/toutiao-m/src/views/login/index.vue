<template>
  <div class="login-container">
    ...
    <!-- 登录表单 -->
    <van-cell-group>
      <van-field v-model="user.mobile" icon-prefix="icon" left-icon="shouji" placeholder="请输入手机号" />
      <van-field v-model="user.code" icon-prefix="icon" left-icon="yanzhengma" placeholder="请输入验证码">
        <template #button>
